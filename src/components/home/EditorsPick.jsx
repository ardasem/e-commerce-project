...
function EditorsPick() {
  return (
    <div className="flex flex-col justify-center items-center pt-[80px] pb-[48px] px-[195px] bg-[#FAFAFA]">
      ...
      <div className="flex flex-col justify-center gap-[30px] my-[48px] md:flex-row">
