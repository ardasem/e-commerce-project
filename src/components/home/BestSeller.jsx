  ...
  return (
    <section className="flex flex-col justify-center items-center gap-5 p-5">
      <div className="flex flex-col justify-center items-center gap-2">
        ...
        <p className="font-['Montserrat'] text-[40px] font-bold">
          BEST SELLER PRODUCTS
        </p>
        <p className="font-['Montserrat'] text-[14px] font-bold text-md-grey">Problems trying to resolve the conflict between</p>
      </div>
